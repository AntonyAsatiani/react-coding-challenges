  ...
  return (
    <div className="app">
      <div className="level">
        ...
        <button className="app__dark-mode-btn icon level-right" onClick={() => setDarkMode(!darkMode)}>
          <FontAwesomeIcon icon={darkMode == false ? faMoon : faSun} color={darkMode ? '#FFA500' : '#000000'} />
        </button>
